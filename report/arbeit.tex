...
Darauf folgen die Implementierungsdetails des Algorithmus und einige vertiefende Beschreibungen, welche Besonderheiten sowie Herausforderungen zu beachten waren, die nötigen Datenstrukturen werden konkretisiert und gelöste Teilprobleme erörtert, im Kapitel~\ref{chap:impl}. Insbesondere dem Finden von Schnitten gebührt ein eigener Text, der Abschnitt~\ref{sec:cutfinding}.
