...
\begin{figure}[p]
  ...
  \caption{Vergleich des durchschnittlichen Flächenbedarfs der verschiedenen Algorithmen nach Anzahl Knoten im Graphen (\subref{fig:areaComparison}) sowie  Verteilung der Anzahl Konten in den Graphen (\subref{fig:graphSizes}).}
