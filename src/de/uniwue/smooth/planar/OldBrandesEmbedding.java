 ...
 * @param <E> Edge type.
 */
public class OldBrandesEmbedding<V, E> extends AdjacencyListEmbedding<V, E> implements Embedding<V, E> {
	...
	public static <V, E> boolean isPlanar(UndirectedGraph<V, E> graph) {
		try {
			new OldBrandesEmbedding<V, E>(graph);
			return true;
	 ...
	 */
	public OldBrandesEmbedding(UndirectedGraph<V, E> graph) throws NotPlanarException {
