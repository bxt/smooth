...
\begin{figure}[h]
        \centering
       \subcaptionbox{Das orthogonale Layout ohne Komprimierung ist 38 Gittereinheiten hoch.\label{fig:smoothOknessRaw} }[0.3\textwidth]
