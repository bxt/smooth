...
public class Rome2939_19Minimized <V, E> implements Factory<UndirectedGraph<V, E>> {
	...
	public UndirectedGraph<V, E> create() {
		...
		graph.addEdge(edges.get( 0), vertices.get( 1), vertices.get( 0));
		graph.addEdge(edges.get( 1), vertices.get( 5), vertices.get( 1));
		graph.addEdge(edges.get( 2), vertices.get( 5), vertices.get( 2));
		graph.addEdge(edges.get( 3), vertices.get( 2), vertices.get( 6));
		graph.addEdge(edges.get( 4), vertices.get( 6), vertices.get( 3));
		graph.addEdge(edges.get( 5), vertices.get( 3), vertices.get( 7));
		graph.addEdge(edges.get( 6), vertices.get( 4), vertices.get( 8));
		graph.addEdge(edges.get( 7), vertices.get( 8), vertices.get( 2));
		graph.addEdge(edges.get( 8), vertices.get( 7), vertices.get( 1));
		...
		graph.addEdge(edges.get(20), vertices.get(10), vertices.get( 6));
